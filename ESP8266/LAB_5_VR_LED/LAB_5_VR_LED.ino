...
void loop() {
  ...
  */
  ...
  หากเป็นบอร์ด  Arduino จะเทียบค่า 0v-5v แต่บอร์ด ESP8266 จะเทียบค่า 0v-3.3v
  เช่น analogWrite(4,127) บอร์ด esp8266 จะส่งแรงดันไฟฟ้าออกไปที่ประมาณ 1.6v ที่ขา gpio 4 เป็นต้น 
